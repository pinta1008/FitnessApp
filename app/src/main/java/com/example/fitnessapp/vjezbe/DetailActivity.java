    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(DetailActivity.this, EditExerciseActivity.class);
                intent.putExtra("dalje_Id", exerciseID);
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<Void> call = exerciseInterface.deleteExercise(exerciseID);
                call.enqueue(new Callback<Void>() {
                    @Override
                    public void onResponse(Call<Void> call, Response<Void> response) {
                        if(response.isSuccessful())
                        {
                            Toast.makeText(DetailActivity.this, "Uspješno obrisano", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(DetailActivity.this, MainActivity.class);
                            startActivity(intent);
                        }
                        else
                        {
                            Toast.makeText(DetailActivity.this, "Neuspješno obrisano", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        call.enqueue(new Callback<ExerciseUser>() {
            ...
            public void onResponse(Call<ExerciseUser> call, Response<ExerciseUser> response) {
                if(response.isSuccessful())
                {
                    ...
                    Toast.makeText(DetailActivity.this, "Uspješno", Toast.LENGTH_SHORT).show();

                }
                else
                {
                    Toast.makeText(DetailActivity.this, "Vježba već postoji", Toast.LENGTH_SHORT).show();
                }
            }
